      ...
      <Container>
        <div className="border-t border-line pt-6">
          ...
          <div className="mt-14 sm:mt-20 lg:grid lg:grid-cols-12 lg:gap-8 xl:mt-24">
            <h3 className="max-w-[15ch] text-display-statement font-medium lg:col-span-7 lg:max-w-none">
              I build with both the product and the implementation in mind.
            </h3>

            <div className="mt-10 max-w-[42rem] space-y-5 text-body text-ink-muted sm:mt-12 lg:col-span-5 lg:col-start-8 lg:mt-0">
              <p>
          ...
          <div className="mt-[var(--section-space-compact)]">
            <h3 className="font-mono text-metadata uppercase text-ink">
              TOOLS &amp; TECHNOLOGIES
            </h3>
